...
namespace NewKarma.Areas.Identity.Data
{
    ...
    {
        private readonly ISecurityTrimmingServices _securityTrimmingService;

        public DynamicPermissionsAuthorizationHandler(ISecurityTrimmingServices securityTrimmingService)
        {
