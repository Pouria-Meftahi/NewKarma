...
namespace NewKarma.Areas.Identity.Data
{
    public interface IApplicationUserManager
    {
        ...
        Task<List<VmUsersManager>> GetAllUserWithRoleAsync();
        Task<VmUsersManager> FindUserWithRolesByIdAsync(string UserId);
        Task<string> GetFullName(ClaimsPrincipal User);
        Task<string> GetRoleSingleOrDefualtAsync(ClaimsPrincipal user);
        string GetUserByIdAsync(string UserId_FK);
        ApplicationUser GetUserEmail(string email);
        #region UserPannel
        VmUsersManager UserInformaiion(string email);
        #endregion
        #endregion
    }
}
