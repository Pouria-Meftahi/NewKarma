...
namespace NewKarma.Migrations
{
    ...
    [Migration("20191009070400_mig14AddTripleManyToManyRelCar_Model_Prod")]
    partial class mig14AddTripleManyToManyRelCar_Model_Prod
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewKarma.Models.Domain.CarModel", b =>
                {
            ...
            modelBuilder.Entity("NewKarma.Models.Domain.RlCarModelProduct", b =>
                {
                    b.Property<int>("CarId");
                    ...
                    b.HasKey("CarId", "CarModelId", "ProductId");

                    b.HasIndex("CarModelId");

                    b.HasIndex("ProductId");

                    b.ToTable("RlCarModelProducts");
                });
            ...
            modelBuilder.Entity("NewKarma.Models.Domain.RlCarModelProduct", b =>
                {
                    b.HasOne("NewKarma.Models.Domain.Car", "Car")
                        .WithMany("RlCarModelProduct")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NewKarma.Models.Domain.CarModel", "CarModel")
                        .WithMany("RlCarModelProduct")
                        .HasForeignKey("CarModelId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NewKarma.Models.Domain.Product", "Product")
                        .WithMany("RlCarModelProduct")
